...
public record PipelineLogConfig(boolean showLine, List<SignalType> signalType) {
  public static final PipelineLogConfig DEFAULT = new PipelineLogConfig(true, List.of(ON_NEXT, ON_ERROR, ON_COMPLETE));
