...
class StatefulStatelessHandlerTest {
  ...
  void applyAllCommands() {
    ...
    // When
    var eventTry = testData.blockingHandler.apply(testData.topic, List.of(testData.create, testData.add, testData.send))
                                           .get();
    // Then
  ...
  void applyOneCommand() {
    ...
    var testData = new SocialNetworkTestData();
    // When
    var events = testData.blockingHandler.apply(testData.topic, testData.create).get();
    // Then
  ...
  void applyTwice() {
    ...
    var testData = new SocialNetworkTestData();
    // When
    var events = testData.blockingHandler.apply(testData.topic, List.of(testData.create, testData.create));
    // Then
