...
public class NettyHttpErrorAdapterTest {
  ...
  public void adaptTest() {
    Function<Throwable, NettyHttpError> mapping = t -> Match(t).of(NettyHttpErrorAdapter.nettyHttpErrorCase(CreationError.class, t, 400),
                                                                   Case($(instanceOf(SavingError.class)),
                                                                        () -> new NettyHttpError(t, 400)),
                                                                   VavrUtils.instanceOfCase(LoginError.class,
                                                                                            new NettyHttpError(t, 403)),
                                                                   NettyHttpErrorAdapter.nettyHttpErrorCase(IllegalArgumentException.class,
                                                                                                            t,
                                                                                                            400),
