...
//import io.memoria.reactive.core.eventsourcing.sharding.AccountStateReducer;
...
//  private final List<StatePipeline<io.memoria.reactive.core.eventsourcing.sharding.Account, io.memoria.reactive.core.eventsourcing.sharding.AccountEvent, io.memoria.reactive.core.eventsourcing.sharding.AccountCommand>> oldPipelines;
//  private final List<StatePipeline<io.memoria.reactive.core.eventsourcing.sharding.Account, io.memoria.reactive.core.eventsourcing.sharding.AccountEvent, io.memoria.reactive.core.eventsourcing.sharding.AccountCommand>> newPipelines;
//
...
//    stream.publish(io.memoria.reactive.core.eventsourcing.sharding.DataSet.personScenario(personsCount, nameChanges).map(ShardingPipelineTest::toMsg))
...
//  }
//
//  private StatePipeline<io.memoria.reactive.core.eventsourcing.sharding.Account, io.memoria.reactive.core.eventsourcing.sharding.AccountEvent, io.memoria.reactive.core.eventsourcing.sharding.AccountCommand> createPipeline(Route route) {
//    return new StatePipeline<>(stateDomain(), stream, transformer, route, LogConfig.FINE);
//  }
//
//  private StateDomain<io.memoria.reactive.core.eventsourcing.sharding.Account, io.memoria.reactive.core.eventsourcing.sharding.AccountEvent, io.memoria.reactive.core.eventsourcing.sharding.AccountCommand> stateDomain() {
//    return new StateDomain<>(io.memoria.reactive.core.eventsourcing.sharding.Account.class,
//                             io.memoria.reactive.core.eventsourcing.sharding.AccountEvent.class,
//                             io.memoria.reactive.core.eventsourcing.sharding.AccountCommand.class,
//                             new Visitor(),
//                             new io.memoria.reactive.core.eventsourcing.sharding.AccountStateDecider(),
//                             new io.memoria.reactive.core.eventsourcing.sharding.AccountStateEvolver(),
//                             new AccountStateReducer());
//  }
//
//  private Flux<io.memoria.reactive.core.eventsourcing.sharding.AccountEvent> accountCreatedStream(String topic, int i) {
//    return stream.subscribe(topic, i, 0).concatMap(msg -> transformer.deserialize(msg.value(), io.memoria.reactive.core.eventsourcing.sharding.AccountEvent.class));
