...
public class KafkaStreamAdmin implements StreamAdmin {
  public static KafkaStreamAdmin create(String urls) {
    return create(urls, Duration.ofMillis(3000), Schedulers.boundedElastic());
  }

  public static KafkaStreamAdmin create(String url, Duration timeout, Scheduler scheduler) {
    return new KafkaStreamAdmin(url, timeout, scheduler);
  }
  ...
  private KafkaStreamAdmin(String url, Duration timeout, Scheduler scheduler) {
